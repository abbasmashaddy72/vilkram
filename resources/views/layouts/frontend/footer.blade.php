            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
                <div class="w-full mb-10">
                    ...
                    <div class="flex items-center -mx-3 mt-3">
                        ...
                        @endif
                        @if (!empty($instagram))
                            <a href="{{ $instagram }}" class="px-3 text-[#dddddd] hover:text-white">
                        ...
                        @endif
                        @if (!empty($twitter))
                            <a href="{{ $twitter }}" class="px-3 text-[#dddddd] hover:text-white">
                        ...
                        @endif
                        @if (!empty($linkedin))
                            <a href="{{ $linkedin }}" class="px-3 text-[#dddddd] hover:text-white">
                                <svg width="18" height="18" viewBox="0 0 18 18" class="fill-current">
                                    <path
                        ...
                        @endif
                        @if (!empty($youtube))
                            <a href="{{ $youtube }}" class="px-3 text-[#dddddd] hover:text-white">
                        ...
                        @endif
                        @if (!empty($google_business))
                            <a href="{{ $google_business }}" class="px-3 text-[#dddddd] hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18" height="18"
                                    viewBox="0 0 172 172" style=" fill:#000000;">
                                    <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1"
                                        stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10"
