    ...
    <form wire:submit.prevent="submit">
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    <select wire:model='team_id'
                        class="form-select appearance-none block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-[#B8DDFF] rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
        ...
        <div class="mb-6">
            <label class="block text-sm text-dark">Patient Name
                ...
                <input type="text"
                    class="w-full border-0 border-b border-[#B8DDFF] focus:border-primary focus:outline-none py-4"
        ...
        <div class="mb-6">
            <label class="block text-sm text-dark">Patient Address
                <span class="text-red-600 ml-2">*</span>
                <textarea class="w-full border-0 border-b border-[#B8DDFF] focus:border-primary focus:outline-none py-4"
            ...
            <div class="flex flex-wrap mb-5 -mx-3">
                <div class="w-full px-3">
                    <label class="block text-sm text-dark">If Yes, state on which condition and when?<span
                        ...
                        <textarea type="text" class="w-full border-0 border-b border-[#B8DDFF] focus:border-primary focus:outline-none py-4"
