<x-guest-layout>
    <header id="header" class="header py-28 text-center md:pt-36 lg:text-left xl:pt-44 xl:pb-32">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
            ...
            <div class="xl:text-right">
                <img class="inline" src="test/images/header-smartphone.png" alt="alternative" />
            </div>
        ...
        <div class="container px-4 sm:px-8 xl:px-4">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="test/images/features-icon-1.svg" alt="alternative" />
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="test/images/features-icon-2.svg" alt="alternative" />
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="test/images/features-icon-3.svg" alt="alternative" />
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="test/images/features-icon-4.svg" alt="alternative" />
                </div>
                <div class="card-body">
                    <h5 class="card-title">Multiple Languages</h5>
                    <p class="mb-4">Choose from one of the 40 languages that come pre-installed and start
                        selling
                        smarter</p>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-image">
                    <img src="test/images/features-icon-5.svg" alt="alternative" />
                </div>
                <div class="card-body">
                    <h5 class="card-title">Free Updates</h5>
                    <p class="mb-4">Don't worry about future costs, pay once and receive all future updates at
                        no extra
                        cost</p>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-image">
                    <img src="test/images/features-icon-6.svg" alt="alternative" />
                </div>
                <div class="card-body">
    ...
    <div id="details" class="pt-12 pb-16 lg:pt-16">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            ...
            <div class="lg:col-span-7">
                <div class="xl:ml-14">
                    <img class="inline" src="test/images/details-1.jpg" alt="alternative" />
                </div>
            </div> <!-- end of col -->
        </div> <!-- end of container -->
    </div>
        ...
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            <div class="lg:col-span-7">
                <div class="mb-12 lg:mb-0 xl:mr-14">
                    <img class="inline" src="test/images/details-2.jpg" alt="alternative" />
                </div>
            </div> <!-- end of col -->
            <div class="lg:col-span-5">
                <div class="xl:mt-12">
        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-x-8">
            ...
            <div class="lg:col-span-8">
                <div class="mb-12 text-center lg:mb-0 lg:text-left xl:mr-6">
                    <img class="inline rounded-lg" src="test/images/details-lightbox.jpg" alt="alternative" />
                </div>
            </div> <!-- end of col -->
            <div class="lg:col-span-4">
                ...
                <p class="mb-4">This is a great app which can help you save time and make your live easier.
                    And it will
    ...
    <div class="pt-16 pb-12">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            <div class="lg:col-span-5">
                <div class="mb-16 lg:mb-0 xl:mt-16">
                    ...
                    <p class="mb-4">Get a glimpse of what this app can do for your marketing automation and
                        understand
                        why current users are so excited when using Pavo
                        together with their teams.</p>
                    <p class="mb-4">We will promptly answer any questions and honor your requests based on
                        the service
                        level agreement</p>
                </div>
            </div> <!-- end of col -->
            <div class="lg:col-span-7">
                <div class="ml-14">
                    <img class="inline" src="test/images/details-3.jpg" alt="alternative" />
                </div>
            </div> <!-- end of col -->
        </div> <!-- end of container -->
    </div>
                ...
                <div class="swiper-container card-slider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="test/images/testimonial-1.jpg" alt="alternative" />
                                <div class="card-body">
                                    <p class="italic mb-3">It's been so fun to work with Pavo, I've managed to
                                        integrate
                                        it properly into my business flow and it's great</p>
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="test/images/testimonial-2.jpg" alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="test/images/testimonial-3.jpg" alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="test/images/testimonial-4.jpg" alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="test/images/testimonial-5.jpg" alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="test/images/testimonial-6.jpg" alt="alternative" />
                                <div class="card-body">
    ...
    <div id="pricing" class="cards-2">
        ...
        <div class="container px-4 pb-px sm:px-8">
            ...
            <p class="mb-16 text-white lg:max-w-3xl lg:mx-auto"> Our pricing plans are setup in such a way that any
                user
                can start enjoying Pavo without worrying so much about costs. They are flexible and work for any type of
                industry </p>
    ...
    <div id="download" class="basic-5">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2">
            <div class="mb-16 lg:mb-0">
                <img src="test/images/conclusion-smartphone.png" alt="alternative" />
            </div>
